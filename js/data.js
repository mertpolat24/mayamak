/* Mayamak site data – machines, products, references */
window.MAYAMAK_DATA = {
  contact: {
    phone: "905419393469",
    phoneDisplay: "+90 541 939 34 69",
  ...
  products: [
    {
      ...
      descEn: "Precision machined parts for the STM 500 mini submarine platform."
    },
    {
      id: "stm-corvette",
  ...
  machines: [
    {
      ...
      descEn: "8-inch CNC lathe delivering high precision and repeatability for cylindrical parts."
    },
    {
      id: "v13-isleme",
      category: "cnc",
      ...
      descEn: "4-axis machining center enabling single-setup processing of complex geometries."
    },
    {
      id: "mazak-torna",
      category: "cnc",
      ...
      descEn: "C-axis Mazak lathe combining milling and turning with live tooling support."
    },
    {
      id: "rayfeng-5eksen",
      category: "cnc",
    ...
    },
    {
      ...
      descEn: "MIG/MAG welding units for steel and aluminum structural joints."
    },
    {
      id: "mx500-kaynak",
      category: "kaynak",
      image: "images/machines/kaynak/mx500-kaynak-5.webp",
      nameTr: "MX500 Kaynak Makinesi (5 Adet)",
      nameEn: "MX500 Welding Machine (5 Units)",
      descTr: "Endüstriyel MX500 serisi kaynak makineleri; yüksek amperajlı sürekli üretim hatları için.",
      descEn: "Industrial MX500 welding machines for high-amperage continuous production lines."
    },
    {
      id: "plazma-kesim",
      category: "kaynak",
      ...
      descEn: "CNC plasma cutting for fast, clean profiles on thick sheet metal."
    },
    {
      id: "tig-kaynak-1",
      category: "kaynak",
      image: "images/machines/kaynak/tig-kaynak-1.webp",
      nameTr: "TIG Kaynak Makinesi",
      nameEn: "TIG Welding Machine",
      descTr: "TIG kaynak; ince sac ve paslanmaz çelik uygulamalarında üstün kaynak kalitesi.",
      descEn: "TIG welding for superior quality on thin sheet and stainless steel."
    },
    {
      id: "tig-kaynak-2",
      category: "kaynak",
      ...
      descEn: "Dual-station TIG line ideal for precision defense components."
    },
    {
      id: "pres-100",
      category: "pres",
      ...
      descEn: "100-ton hydraulic press for sheet forming and die operations."
    },
    {
      id: "pres-120",
      category: "pres",
      ...
      descEn: "120-ton press fleet for high-efficiency stamping and deep drawing."
    },
    {
      id: "pres-150",
      category: "pres",
      ...
      descEn: "High stroke speed 150-ton press optimized for serial production lines."
    },
    {
      id: "pres-30",
      category: "pres",
      image: "images/machines/pres/pres-30-ton-3.webp",
      nameTr: "30 Ton Pres (3 Adet)",
      nameEn: "30 Ton Press (3 Units)",
      descTr: "Kompakt 30 ton presler; küçük parça ve prototip üretiminde esneklik.",
      descEn: "Compact 30-ton presses for flexibility in small parts and prototyping."
    },
    {
      id: "pres-egzantrik",
      category: "pres",
      ...
      descEn: "Mechanical eccentric presses for high-frequency sheet cutting and punching."
    },
    {
      id: "surucu-42",
      category: "surucu",
      ...
      descEn: "42 mm automatic bar feeder for uninterrupted lathe production."
    },
    {
      id: "surucu-65",
      category: "surucu",
      ...
      descEn: "65 mm bar feeder providing automation support for medium-diameter parts."
    },
    {
      id: "halat-sarma",
      category: "universal",
      ...
      descEn: "Wire rope winding machine for cable and rope assembly operations."
    },
    {
      id: "lazer-markalama",
      category: "universal",
      ...
      descEn: "Fiber laser marking for permanent part numbering and traceability."
    },
    {
      id: "otomatik-testere",
      category: "universal",
      ...
      descEn: "Automatic band saw for fast, smooth profile and bar cutting."
    },
    {
      id: "ovalama",
      category: "universal",
      ...
      descEn: "Thread rolling machines for cold forming of screw threads and profiles."
    },
    {
      id: "percın-pres",
      category: "universal",
      ...
      descEn: "Rivet staking press for reliable joints in sheet assemblies."
    },
    {
      id: "radyal-matkap",
      category: "universal",
      ...
      descEn: "Radial drill presses for precision drilling on large workpieces."
    },
    {
      id: "vibrasyon",
      category: "universal",
      ...
      descEn: "Vibration finishing machines for surface cleaning and edge rounding."
    }
  ],
  ...
  categoryLabels: {
    ...
    universal: { tr: "Universal Makineler", en: "Universal Machines" }
  }
};
